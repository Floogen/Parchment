...
namespace Parchment.Framework.Models.Data.Results
{
    ...
    public class ResultsData : BaseModel
    {
        ...
        public string Source { get; set; } = "ALL_ITEMS (O)";
        ...
        /// <summary>The InputId whose text narrows the candidates. When null the results are unfiltered, which is a plain paged list of everything the source returned.</summary>
        ...
        /// <summary>How many cells the results fill. When null the grid's Columns and Rows decide, which is the usual way to say it.</summary>
